...
## Chokes and Combeacks for Home v. Visitor
...
home_team_chokes$loc <- "home"
home_team_chokes$result <- "choke"
home_team_comebacks$loc <- "home"
...
away_team_chokes$loc <- "away"
away_team_chokes$result <- "choke"
away_team_comebacks$loc <- "away"
...
longer_joined_team_data_1 <- longer_joined_team_data %>% filter()
