...
The height of the plot is represented by the % of points scored by each category before and after the inflection (or choke) point.Therefore, the addition of all scorers then will ad up to 1.0 for before choke and after choke, respectively.
