...
choke_list_frame <- read.csv(file="data/choke_list_full.csv")
...
```{r}
pbp_frame <- read.csv(file="data/pbp_data_full_R.csv")
...
```{r}
player_split_data <- read.csv("data/player_scoring_data.csv")
